<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="customervault-mandate-w-BACSAccount.aspx.cs" Inherits="SampleApp.customervault_mandate_w_BACSAccount" %>
...
<body>
    ...
    <form runat="server">
        <fieldset>
            <legend>BACS Bank Account Details With Mandate</legend>
             <div>
                <label>
                    Nick Name: 
