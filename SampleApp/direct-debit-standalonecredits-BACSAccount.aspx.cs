...
using StandaloneCredits = OptimalPayments.DirectDebit.StandaloneCredits;

namespace SampleApp
{
    public partial class direct_debit_standalonecredits_BACSAccount : System.Web.UI.Page
    {
