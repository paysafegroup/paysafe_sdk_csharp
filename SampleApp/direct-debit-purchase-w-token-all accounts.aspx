<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="direct-debit-purchase-w-token-all accounts.aspx.cs" Inherits="SampleApp.direct_debit_purchase_w_token_all_accounts" %>
...
<body>
    ...
    <form runat="server">
        <fieldset>
            <legend>Direct Debit Purchase With Token</legend>                            
            ...
            <asp:RadioButtonList ID="radio" runat="server" 
                ...
                <asp:ListItem Text="SEPA" Value="SEPA"></asp:ListItem>                
            </asp:RadioButtonList>            
            </div>
            <div>
                <label>
