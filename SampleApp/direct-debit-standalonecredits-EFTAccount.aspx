<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="direct-debit-standalonecredits-EFTAccount.aspx.cs" Inherits="SampleApp.direct_debit_standalonecredits_EFTAccount" %>
    ...
    <form runat="server">
        <fieldset>
            ...
            <div>
                <label>
                    Account Number: 
						<input type="text" name="account_number" value="<% Response.Write("77832467"); %>" />
                </label>
            </div>
            <div>
                <label>
